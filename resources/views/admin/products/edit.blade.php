                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control" placeholder="Title" value="{{ $product->name }}">
                                                    <p class="error"></p>	
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <div class="card-body">	
                                        ...
                                        <div class="mb-3">
                                            <select name="is_featured" id="is_featured" class="form-control">
                                                <option {{ ($product->is_featured_id == 'No') ? 'selected' : ''}} value="No">No</option>
                                                <option {{ ($product->is_featured_id == 'Yes') ? 'selected' : ''}} value="Yes">Yes</option>                                                
                                            </select>
                                            <p class="error"></p>
                                        </div>
                                    </div>
